...
import idle from '@/assets/Zombie_3/Idle.png';
import attack from '@/assets/Zombie_3/Attack.png';
import dead from '@/assets/Zombie_3/Dead.png';
import death from '@/assets/Zombie_3/Death.png';
import hit from '@/assets/Zombie_3/Hurt.png';
import move from '@/assets/Zombie_3/Walk.png';
...
export const attackAnimation = () =>
  createAnimation(attackUrl, 4, 100, 'attack');
...
export function createSavageZombieAnimations(): SpriteAnimations<EnemyAction> {
  return {
    idle: idleAnimation(),
